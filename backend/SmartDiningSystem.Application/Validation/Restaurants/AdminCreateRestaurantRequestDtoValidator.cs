...
public class AdminCreateRestaurantRequestDtoValidator : AbstractValidator<AdminCreateRestaurantRequestDto>
{
    public AdminCreateRestaurantRequestDtoValidator()
    {
